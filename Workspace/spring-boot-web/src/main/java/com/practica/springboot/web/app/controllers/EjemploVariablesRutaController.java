...
public class EjemploVariablesRutaController {
	...
	public String variables(@PathVariable String texto, Model modelo){//enviamos datos por la ruta utilizando la anotacion @PathVariable 
	...
	public String variables(@PathVariable String texto, @PathVariable Integer numero, Model modelo){//enviamos diferentes tipos de datos por la ruta utilizando mas anotaciones @PathVariable 
